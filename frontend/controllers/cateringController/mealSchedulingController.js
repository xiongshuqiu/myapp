...
// 1.获取所有老人请假请求
const getAllMealSchedulings = async (req, res) => {
...
// 2.创建新的老人请假请求
//(1)显示新增老人请假请求表单
const renderNewMealSchedulingForm = async (req, res) => {
...
//(2)提交新的老人请假请求数据
const createMealScheduling = async (req, res) => {
  const {
    elderlyId,
    reason,
    startDate,
...
// 3.更新特定老人请假请求
// (1)查找特定老人请假请求并显示编辑表单
const getMealSchedulingById = async (req, res) => {
...
//(2) 提交更新后的老人请假请求数据
const updateMealScheduling = async (req, res) => {
  const {
    elderlyId,
    reason,
    startDate,
...
// 4. 删除特定老人档案
const deleteMealScheduling = async (req, res) => {
  try {
